...
boosting_rounds_num_list = [3,5,10,20]
...
boosting_rounds_stats = BoostingRoundsCrossValidation.ensemble_model_boosting_rounds_cross_validate(boosting_rounds_num_list, training_dataframe=pd.read_csv("data/normalized/normalized_parkinsons_training.data"))
